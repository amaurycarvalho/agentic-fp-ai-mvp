...
- [x] Completar caso de uso inicial `UC-MCP-001` e adicionar UCs iniciais de `rag-service` e `agent-service`.

## Próximos passos

- [ ] Implementar o endpoint de negócio inicial do `mcp-service` para contagem básica (além de health-check).
