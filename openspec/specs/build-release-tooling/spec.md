...
Define o tooling de build, teste, qualidade, CI/CD e release do projeto
`agentic-fp-ai-mvp`, alinhado à estrutura real de 3 serviços e solução raiz única
(`agentic-fp-ai-mvp.sln`), sem referências a serviços ou artefatos inexistentes.
