...
Capacidade de contagem básica de Pontos de Função do `mcp-service` (protótipo):
classificação determinística EI/EO/EQ e ILF/EIF por palavras-chave, complexidade
DET×FTR, pesos IFPUG transacionais e trilha de auditoria justificável.
